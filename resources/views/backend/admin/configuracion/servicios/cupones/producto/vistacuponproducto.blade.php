    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header" id="card-header-color">
                <h3 class="card-title" style="color: white">Lista de Cupones de Producto Gratis</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Nombre de Cupón de Producto Gratis:</label>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var id = {{ $id }};
            var ruta = "{{ URL::to('/admin/cupones/servicio/progratis/tabla/') }}/"+id;
    ...
    <script>
        ...
        function guardarRegistro(){
            ...
            axios.post('/admin/cupones/servicio/progratis/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function borrarCupon(id){
            ...
            axios.post('/admin/cupones/servicio/progratis/borrar',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
