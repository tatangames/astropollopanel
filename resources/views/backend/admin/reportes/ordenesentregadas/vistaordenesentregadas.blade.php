...
<section class="content-header">
    <div class="container-fluid">
        <div class="col-sm-12">
            <h1>Reporte de Ordenes Entregadas por Motoristas</h1>
        </div>
    </div>
</section>
                    ...
                    <form>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="select-restaurante" onchange="buscarMotorista()">
...
@section('archivos-js')
    ...
    <script>
        ...
        function buscarMotorista(){
            ...
            axios.post('/admin/reportes/buscar/motorista',{
                'id': idservicio
            })
                .then((response) => {
                    closeLoading();
        ...
        function buscarReporte(){
            ...
            var idservicio = document.getElementById('select-restaurante').value;
            var idmotorista = document.getElementById('select-motorista').value;
            ...
            if(idmotorista === ''){
                toastr.error("Motorista es requerido");
                return;
            }
            ...
            window.open("{{ URL::to('admin/pdf/ordenes/entregadas') }}/" + idmotorista + "/" + idservicio + "/" +  fechadesde + "/" + fechahasta);
        }
