...
<section class="content-header">
    <div class="container-fluid">
        <div class="col-sm-12">
            <h1>Listado de Ordenes Canceladas Hoy: {{ $fecha }}</h1>
        </div>
                ...
                <form id="formulario-proceso">
                    <div class="card-body">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label>Cancelada Por</label>
                                <input type="text" style="color: red" disabled autocomplete="off" class="form-control" id="canceladopor-orden">
                            </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('admin/ordenes/canceladashoy/listado/tabla') }}";
                ...
                .then((response) => {
                    ...
                    if (response.data.success === 1) {
                        ...
                        $.each(response.data.info, function( key, val ){
                            ...
                            if(val.cancelado_por === 1){
                                $('#canceladopor-orden').val("Cliente");
                            }else{
                                $('#canceladopor-orden').val("Restaurante");
                            }
