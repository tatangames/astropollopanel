                    ...
                    <div class="card-body">
                        <table id="tabla" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th style="width: 10%">Fecha Cancelado</th>
                                <th style="width: 10%">Cancelado Por</th>
                                <th style="width: 10%">Nota Cancelada</th>
                            ...
                            @foreach($ordenes as $dato)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $dato->fecha_cancelada }}</td>

                                    <td>{{ $dato->canceladopor }}</td>
                                    <td>{{ $dato->nota_cancelada }}</td>
                                    <td>
